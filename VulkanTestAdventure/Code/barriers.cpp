...
namespace vk_test {
    ...
    void vk_test::BarrierContainer::cmdPipelineBarrier(VkCommandBuffer cmd, VkDependencyFlags dependencyFlags) {
    ...
    void vk_test::BarrierContainer::appendOptionalLayoutTransition(Image& image, VkImageMemoryBarrier2 imageBarrier) {
