    ...
    public:
        ...
        void createScene() {
            ...
            // Load the GLTF resources
            {
                ...
                // Textures
                {
                    std::filesystem::path imageFilename = nvutils::findFile("tiled_floor.png", getResourcesDirs());
        ...
        void updateTextures() {
            ...
            Image* allImages = m_textures.data();
        ...
        VkShaderModuleCreateInfo compileSlangShader(const std::filesystem::path& filename, const std::span<const uint32_t>& spirv) {
            ...
            std::filesystem::path shaderSource = nvutils::findFile(filename, getShaderDirs());
        ...
        void createBottomLevelAS() {
            ...
            for (uint32_t blasId = 0; blasId < m_sceneResource.meshes.size(); blasId++) {
                ...
                createAccelerationStructure(VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR, m_blasAccel[blasId], asGeometry, asBuildRangeInfo, VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_KHR);
