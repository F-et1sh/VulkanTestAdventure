...
VKHppTest::SwapchainManager::SwapchainManager(DeviceManager* device_manager, Window* window, GPUResourceManager* gpu_resource_manager, RenderPassManager* render_pass_manager) : p_DeviceManager{ device_manager }, p_Window{ window }, p_GPUResourceManager{ gpu_resource_manager }, p_RenderPassManager{ render_pass_manager } {}
