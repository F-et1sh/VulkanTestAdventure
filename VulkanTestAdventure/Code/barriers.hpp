...
namespace vk_test {
    ...
    [[nodiscard]] constexpr VkAccessFlags2 inferAccessMaskFromStage(VkPipelineStageFlags2 stage, bool read) {
        ...
        if ((stage & (VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT | VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT | VK_PIPELINE_STAGE_2_VERTEX_SHADER_BIT | VK_PIPELINE_STAGE_2_MESH_SHADER_BIT_EXT | VK_PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHR | VK_PIPELINE_STAGE_2_TASK_SHADER_BIT_EXT | VK_PIPELINE_STAGE_2_PRE_RASTERIZATION_SHADERS_BIT | VK_PIPELINE_STAGE_2_TESSELLATION_CONTROL_SHADER_BIT | VK_PIPELINE_STAGE_2_TESSELLATION_EVALUATION_SHADER_BIT | VK_PIPELINE_STAGE_2_GEOMETRY_SHADER_BIT)) != 0) {
    ...
    [[nodiscard]] constexpr std::tuple<VkPipelineStageFlags2, VkAccessFlags2> inferPipelineStageAccessTuple(VkImageLayout state) {
        switch (state) {
            ...
            case VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL:
                return std::make_tuple(VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT | VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT | VK_PIPELINE_STAGE_2_PRE_RASTERIZATION_SHADERS_BIT | VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT,
                                       VK_ACCESS_2_SHADER_READ_BIT);
            case VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL:
                return std::make_tuple(VK_PIPELINE_STAGE_2_TRANSFER_BIT, VK_ACCESS_2_TRANSFER_WRITE_BIT);
            case VK_IMAGE_LAYOUT_GENERAL:
                return std::make_tuple(VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT | VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT | VK_PIPELINE_STAGE_2_PRE_RASTERIZATION_SHADERS_BIT | VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT | VK_PIPELINE_STAGE_2_TRANSFER_BIT,
                                       VK_ACCESS_2_SHADER_READ_BIT | VK_ACCESS_2_SHADER_WRITE_BIT | VK_ACCESS_2_SHADER_WRITE_BIT | VK_ACCESS_2_TRANSFER_WRITE_BIT);
    ...
    [[nodiscard]] constexpr VkBufferMemoryBarrier2 makeBufferMemoryBarrier(const BufferMemoryBarrierParams& params) {
        const VkBufferMemoryBarrier2 buffer_barrier{
            ...
            .srcStageMask        = params.srcStageMask,
            .srcAccessMask       = params.srcAccessMask != INFER_BARRIER_PARAMS ? params.srcAccessMask : inferAccessMaskFromStage(params.srcStageMask, false),
            .dstStageMask        = params.dstStageMask,
            .dstAccessMask       = params.dstAccessMask != INFER_BARRIER_PARAMS ? params.dstAccessMask : inferAccessMaskFromStage(params.dstStageMask, true),
            .srcQueueFamilyIndex = params.srcQueueFamilyIndex,
            .dstQueueFamilyIndex = params.dstQueueFamilyIndex,
    ...
    [[nodiscard]] constexpr VkMemoryBarrier2 makeMemoryBarrier(VkPipelineStageFlags2 src_stage_mask,
        ...
        const VkMemoryBarrier2 memory_barrier{
            ...
            .srcAccessMask = (src_access_mask != INFER_BARRIER_PARAMS) ? src_access_mask : inferAccessMaskFromStage(src_stage_mask, false),
            .dstStageMask  = dst_stage_mask,
            .dstAccessMask = (dst_access_mask != INFER_BARRIER_PARAMS) ? dst_access_mask : inferAccessMaskFromStage(dst_stage_mask, true)
        };
